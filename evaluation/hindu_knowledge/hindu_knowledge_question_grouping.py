...
parser.add_argument("--group_num", default=3, help='group number')
parser.add_argument("--model_size_uplimit", default=10)
...
directory_path = 'hindu_knowledge'
...
if args.redist:
    eval_data.to_csv(f'hindu_knowledge_instance_brier_{args.model_size_downlimit}_{args.model_size_uplimit}_{args.group_num}_redist.csv', index=False)
else:
    eval_data.to_csv(f'hindu_knowledge_instance_brier_{args.model_size_downlimit}_{args.model_size_uplimit}_{args.group_num}_undist.csv', index=False)