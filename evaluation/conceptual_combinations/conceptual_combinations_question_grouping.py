...
directory_path = 'conceptual_combinations'
...
if args.redist:
    eval_data.to_csv(f'conceptual_combinations_instance_brier_{args.model_size_downlimit}_{args.model_size_uplimit}_{args.group_num}_redist.csv', index=False)
else:
    eval_data.to_csv(f'conceptual_combinations_instance_brier_{args.model_size_downlimit}_{args.model_size_uplimit}_{args.group_num}_undist.csv', index=False)