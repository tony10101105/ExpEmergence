...
parser.add_argument("--model_size_uplimit", default=63.09573444801933)
...
if args.redist:
    eval_data.to_csv(f'acc_arithmetic_instance_brier_{args.model_size_downlimit}_{args.model_size_uplimit}_{args.group_num}_redist.csv', index=False)
else:
    eval_data.to_csv(f'acc_arithmetic_instance_brier_{args.model_size_downlimit}_{args.model_size_uplimit}_{args.group_num}_undist.csv', index=False)